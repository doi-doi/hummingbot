...
class GatewayPaths:
    ...
    def __post_init__(self):
        ...
        """
        # for path in [self.local_conf_path, self.local_certs_path]:
        #     path.mkdir(mode=0o755, parents=True, exist_ok=True)
        self.local_certs_path.mkdir(mode=0o755, parents=True, exist_ok=True)
...
def get_gateway_paths(client_config_map: "ClientConfigAdapter") -> GatewayPaths:
    ...
    #     if inside_docker
    #     else Path.home().joinpath(f".hummingbot-gateway")
    # )
    # conf_path: Path = (
    ...
    # )
    local_certs_path: Path = base_path
    mount_certs_path: Path = external_certs_path
